...
const AuthModal = ({ onClose, onAuthSuccess }) => {
  ...
  const signInWithGoogle = async () => {
    ...
    try {
      ...
      // Show error for real issues
      setError(err.code === 'auth/popup-blocked' ? 'Please allow popups' : 'Sign-in failed. Try again.');
    }
  };
      ...
      <div className="auth-modal">
        ...
        <div className="modal-footer">
          ...
          <p className="privacy-text">
            ...
            <a href="#terms" className="policy-link" onClick={onClose}>Terms of Service</a>
            {' '}and{' '}
            <a href="#privacy" className="policy-link" onClick={onClose}>Privacy Policy</a>
          </p>
        </div>
      </div>
    </div>
